...
public class InstructorController {
    ...
    public Instructor createUser(@Valid @RequestBody Instructor instructor) {
        instructor.setId(sequenceGeneratorService.generateSequence(Instructor.SEQUENCE_NAME));
    ...
    public Map < String, Boolean > deleteUser(
        @PathVariable(value = "id") Long instructorId) throws ResourceNotFoundException {
        Instructor instructor = instructorRepository.findAllById(instructorId)
            .orElseThrow(() -> new ResourceNotFoundException("Instructor not found :: " + instructorId));

        instructorRepository.deleteById((long) instructor.getId());
